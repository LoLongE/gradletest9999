...
$(document).ready(function () {	  
	  $('[name="board_status"] option[value=' + ${result.board_status} + ']').attr('selected', 'selected');
	  var x = ${result.board_money};
	  x = x.toString();
	  numberWithCommasMoney(x);
	  var y = ${result.board_tax};
	  y = y.toString();
	  numberWithCommasTex(y);
	});
</script>
					...
					<div class="box">
							...
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="datepicker" name="board_regist_date"
										class="span15" value="${result.board_regist_date}"
										autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="current-pass-control1"
										name="board_source" class="span15"
										value="${result.board_source}" autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="current-pass-control2"
										name="board_destination" class="span15"
										value="${result.board_destination}" autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="current-pass-control3" name="board_tel"
										class="span15" value="${result.board_tel}"
										autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
								...
								<div class="controls">
									<select id="challenge_question_control" class="span15"
										name="board_status">										
							...
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="current-pass-control5"
										name="board_money" class="span15"
										value="${result.board_money}" onkeyup="numberWithCommasMoney(this.value)" autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
								...
								<div class="controls">
									<input type="text" id="current-pass-control5"
										name="board_tax" class="span15"
										value="${result.board_tax}" onkeyup="numberWithCommasTax(this.value)" autocomplete="false">
								</div>
							</div>
							<div class="control-group ">
						...
						<div class="box-footer">
							...
							<button id="submit-button" type="submit" class="btn btn-primary"
								name="board_insert_button" value="CONFIRM">수정</button>
