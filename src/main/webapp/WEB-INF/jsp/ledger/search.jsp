	...
	<div id="body-container">
		<div id="body-content">
			...
			<div class="container">
				<div class="row">
					<div class="span7">
						<header class="page-header"><h3>검색</h3></header>
					</div>
				</div>
			</div>
			</section>
					...
					<div class="box pattern">
						...
						<div class="box-content">
							...
							<div class="control-group ">
								<label class="control-label">물품 등록 날짜 </label>
								<div class="controls">
								...
								<div class="control-group ">
									...
									<div class="controls">
										<input type="text" id="current-pass-control1" name="board_source" class="span15" value="" autocomplete="false">
									</div>
									<div class="control-group ">
										<label class="control-label">하차지 </label>
										<div class="controls">
											<input type="text" id="current-pass-control1" name="board_destination" class="span15" value="" autocomplete="false">
										</div>
										...
										<div class="box-footer">
											...
											<button id="submit-button" type="submit" class="btn btn-primary" name="board_insert_button" value="CONFIRM">검색</button>
