	...
	<div id="body-container">
		<div id="body-content">
			...
			<div class="container">
				<div class="row">
					<div class="span7">
						<header class="page-header"><h3>조회</h3></header>
					</div>
				</div>
			</div>
			</section>
        ...
        container.pagination({
            ...
            callback: function (data, pagination) {	            		            	
                ...
                $.each(data, function (index, item) {	                	
                    ...
                    if(status=="1") {
                    	item.ledger_status = "<a href='javascript:;' class='btn btn-small btn-success'>사무실</a>"
                    } else if (status=="2" || status=="3") {
                    	item.ledger_status = "<a href='javascript:;' class='btn btn-small btn-warning'>24시콜&원콜</a>"
                    }
                    if (money_status=="1") {
                    	item.ledger_money_status = "<a href='javascript:;' class='btn btn-small btn-danger'>미입금</a>"
                    } else if(money_status=="2") {
                    	item.ledger_money_status = "<a href='javascript:;' class='btn btn-small btn-info'>입금완료</a>"
                    }                     
                   	dataHtml += 
